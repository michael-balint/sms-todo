...
// local js libraries
var userTable = require('./user-table.js');
...
module.exports = {
  ...
  createTodo: function(inputText, userData, callback) {
  ...
  listTodo: function(inputText, userData, callback) {
  ...
  // handle all input conditions from user
  editTodo: function(inputText, userData, callback) {
  ...
  removeTodo: function(inputText, userData, callback) {
  ...
  updateSettings: function(inputText, userData, callback) {
  ...
  processMessage: function(inputText, userData, callback) {
  ...
  initialSetup: function(inputText, userData, callback) {
